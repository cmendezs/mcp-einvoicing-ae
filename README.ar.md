...
> **نُشر الإصدار v0.1.0 بتاريخ 2026-08-27 — الإصدار الأول.** نماذج `AEInvoice` وَ`AEParty`
> وَ`AETaxDataDocument`، وأدوات التحقق المُجمَّعة (Schematron/XSD)، وأدوات MCP الخاصة بالتوليد
> والتحقق والتحليل، جميعها منفَّذة ومتاحة على PyPI وسجل MCP. راجع
> [الحالة الراهنة](#الحالة-الراهنة) لمعرفة ما تبقى مفتوحاً (لا شيء منه يعيق هذا الإصدار).
