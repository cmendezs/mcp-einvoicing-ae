...
> **نُشر الإصدار v0.2.0 بتاريخ 2026-08-28.** نماذج `AEInvoice` وَ`AEParty` وَ`AETaxDataDocument`،
> وأدوات MCP الخاصة بالتوليد والتحقق والتحليل، متاحة على PyPI وسجل MCP. أصبحت الأداة
> `validate_invoice_ae` تتحقق الآن وفق مخطط Schematron الأساسي المشترك CEN EN16931 بدلاً من
> ملفات XSLT المُجمَّعة ذاتياً من مصادر OpenPeppol التي ضمّنها الإصدار v0.1.0 دون تأكيد حقوق
> إعادة التوزيع؛ أما الأداة `validate_tdd_ae` فتُعيد حالياً نتيجة "غير متاحة" — انظر
