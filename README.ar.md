...
## الحياد تجاه مقدّمي الخدمة

يُنفّذ هذا الخادم المعيار بنفسه: فهو يُنشئ المستند ويتحقق منه ويوقّعه محليًا. إنه ليس عميلًا
لمنصة فوترة تجارية، ومفاتيح التوقيع وبيانات الاعتماد الخاصة بك لا تغادر بنيتك التحتية أبدًا.

نقطة وصول Peppol مطلوبة لـ PINT AE / Peppol AE TDD، لكن أي نقطة وصول معتمدة تتحدث نفس بروتوكول
AS4، لذا فإن تغيير مزوّد الخدمة هو تغيير في الإعداد، وليس تغييرًا في الكود.
